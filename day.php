...
echo "<script type=\"text/javascript\">
  ...
  newPopup('https://reservas-dev.ic.unicamp.br/politica.pdf');
</script>";
echo "<div id=\"dwm\">\n";
echo "<h2>" . utf8_strftime($strftime_format['date'], $timestamp) . "</h2>\n";
echo "<h2><center> Reservas e informações podem ser obtidas através do email <a style=\"color:red\" href=\"mailto:reservas@ic.unicamp.br\"> reservas@ic.unicamp.br </a></center></h2>\n";
echo "<h2><center>Atenção: Antes de efetuar uma reserva, observar a <a style=\"color:red\" href=\"JavaScript:newPopup('https://reservas-dev.ic.unicamp.br/prioridades.html');\">prioridade</a> de uso de cada sala, bem como a <a style='color:red;cursor:pointer' onclick=\"newPopup('https://reservas-dev.ic.unicamp.br/politica.pdf');\">política</a> de uso de espaços.</center></h2>\n";
echo "<h2><center> As reservas estão sujeitas a alteração.</h2>\n";
if ($display_timezone)
{
